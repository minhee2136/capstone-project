...
urlpatterns = [
    ...
    path('sessions/<int:session_id>/context/', views.SessionContextView.as_view(), name='session-context'),
    ...
    path('sessions/<int:session_id>/summary/script/', views.SessionSummaryScriptView.as_view(), name='session-summary-script'),
